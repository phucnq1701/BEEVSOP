...
import { Button, Screen, Text, useCountdown } from "../../components"
...
export const CodeInputScreen = observer(function CodeInputScreen({ route }) {
  ...
  const onLoginState = async () => {
    setIsPlaying(false)
    await userStore.getUser({ DiDong: phone.replace("+84", "0") })
  ...
  return (
    <Screen style={ROOT} preset="scroll">
      <View>
        <Text style={titleStyle}>Mã xác thực OTP</Text>
